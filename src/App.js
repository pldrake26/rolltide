  ...
  render() {
    return (
      <div className="container-fluid" style={styles}>
        ...
        <Dates helmet={ColoradoState} date="September 16" team="Colorado State Rams" time="6:00pm" outcome = "WIN" final="41-23"/>
        <Dates helmet={Commodores} date="September 23" team="&#64;&nbsp;Vanderbilt Commodores" time="2:30pm" outcome="" final="TBD"/>
